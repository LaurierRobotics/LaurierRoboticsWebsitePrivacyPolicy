  ...
  return (
    <div className="App">
      ...
      <body>
        ...
        <p>The Laurier Robotics Team built the Laurier Robotics website as an open source and free
        website. This SERVICE is provided by Laurier Robotics at no cost and is intended
        for use as is.</p>
        ...
        which is accessible at Laurier Robotics, unless otherwise defined in this Privacy Policy.</p>
        <br />
        ...
        <p>The website does use third party services that may collect information used to identify you. Laurier Robotics uses Firebase
        Authentication
        to verify the users' identify through email and password. Also we use Firebase
        Cloud Storage to collect user images.</p>
        <br />
        <p><strong>Log Data</strong></p>
        <p>We want to inform you that whenever you use our Service, in case of an error in the website we collect
        data and information (through third party products) on your phone called Log Data. This Log Data
        may include information such as your devices’s Internet Protocol (“IP”) address, device name,
        operating system version, configuration of the website when utilising our Service, the time and date
        ...
        internal memory.</p>
        <p>This Services does not uses these “cookies” explicitly. However, the website may use third party code
